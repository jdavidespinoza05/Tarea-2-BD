-- Script de carga de datos para Tarea 2 (Versión Definitiva)
...
IF NOT EXISTS (SELECT 1 FROM Error WHERE Id = 10) INSERT INTO Error (Id, Codigo, Descripcion) VALUES (10, '50010', 'Valor de documento de identidad no alfabético');
