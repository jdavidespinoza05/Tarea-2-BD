...
PRINT 'Simulación de Operaciones (fecha por fecha)';
...
PRINT 'Procesando operaciones para la fecha: 2015-11-30';
...
PRINT 'Procesando operaciones para la fecha: 2017-12-17';
...
PRINT 'Procesando operaciones para la fecha: 2018-11-24';
...
PRINT 'Procesando operaciones para la fecha: 2019-09-05';
...
PRINT 'Procesando operaciones para la fecha: 2021-05-13';
...
PRINT 'Procesando operaciones para la fecha: 2021-07-25';
...
PRINT 'Procesando operaciones para la fecha: 2021-10-16';
...
PRINT 'Procesando operaciones para la fecha: 2022-01-08';
...
PRINT 'Procesando operaciones para la fecha: 2022-04-27';
...
PRINT 'Procesando operaciones para la fecha: 2022-05-10';
...
PRINT 'Procesando operaciones para la fecha: 2022-10-27';
...
PRINT 'Procesando operaciones para la fecha: 2022-11-29';
...
PRINT 'Procesando operaciones para la fecha: 2023-02-13';
...
PRINT 'Procesando operaciones para la fecha: 2024-04-29';
...
PRINT 'Procesando operaciones para la fecha: 2024-06-21';
...
PRINT 'Procesando operaciones para la fecha: 2024-08-04';
...
PRINT 'Procesando operaciones para la fecha: 2025-01-10';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
ELSE
    PRINT 'Error: No se pudo insertar el movimiento porque el usuario no existe.';


PRINT 'Procesando operaciones para la fecha: 2025-01-11';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-01-19';
...
PRINT 'Procesando operaciones para la fecha: 2025-01-20';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-01-26';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-01-30';
...
PRINT 'Procesando operaciones para la fecha: 2025-02-04';
...
PRINT 'Procesando operaciones para la fecha: 2025-02-05';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-06';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-07';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-08';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-10';
...
PRINT 'Procesando operaciones para la fecha: 2025-02-11';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-14';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-15';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-16';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-19';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-27';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-02-28';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-03-01';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-03-09';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-03-10';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-03-13';
...
PRINT 'Procesando operaciones para la fecha: 2025-03-15';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-03-22';
...
PRINT 'Procesando operaciones para la fecha: 2025-03-26';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-03-27';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-04-11';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-04-13';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-04-16';
...
PRINT 'Procesando operaciones para la fecha: 2025-04-17';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-04-24';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-04-25';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alejandro';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-04-29';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-04-30';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-05-02';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-05-05';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-05-07';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-05-08';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-05-09';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-05-22';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-02';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alejandro';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-03';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-06';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-10';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-11';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-13';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-14';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-17';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-19';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-06-27';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-07-05';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-07-21';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-07-22';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-07-23';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-07-25';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-07-29';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-06';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alejandro';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-10';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-11';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-12';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alejandro';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-13';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alejandro';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-15';
...
PRINT 'Procesando operaciones para la fecha: 2025-08-17';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-24';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-08-25';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-09-02';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-09-19';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alejandro';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-09-20';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alejandro';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-10-09';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-10-16';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-10-18';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-10-23';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-01';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-04';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-09';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-14';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'UsuarioScripts';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-21';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Alex';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-26';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-27';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-11-28';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Daniel';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-12-01';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-12-02';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'David';
IF @IdUsuarioMov IS NOT NULL
...
PRINT 'Procesando operaciones para la fecha: 2025-12-27';
SELECT @IdUsuarioMov = Id FROM Usuario WHERE Username = 'Esteban';
IF @IdUsuarioMov IS NOT NULL
